    ...
    try:
        ...
        async with httpx.AsyncClient() as client:
            ...
            if relevant:
                ...
                if notifications: await update_last_processed_secret(latest_idx)
